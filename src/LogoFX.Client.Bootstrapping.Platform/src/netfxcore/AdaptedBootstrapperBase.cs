...
namespace Caliburn.Micro
{
    ...
    /// </summary>
    public abstract class AdaptedBootstrapperBase
    {
        ...
        /// </summary>
        /// <param name="useApplication">Set this to false when invoking bootstrapper outide the package assembly. The default is true.</param>
        protected AdaptedBootstrapperBase(bool useApplication = true)
        {            
        ...
        protected void Initialize()
        {
            ...
            AssemblySourceCache.ExtractTypes = assembly =>
            {
                ...
                var elementTypes = assembly.ExportedTypes
                    .Where(t => ExtensionMethods.IsAssignableFrom(typeof(UIElement), t));
        ...
        //Source of the fact that real C.Micro bootstrapper HAS to inherit from
        //the Application and not just wrap it.
        ///// <summary>
